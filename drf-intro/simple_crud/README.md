...
## Solution
- выполнены задания: создан API интерфейс с использованием ViewSet, настроены сериализаторы, вью классы, роутер, сделан абстрактный класс и наследование от него, добавлена возможность сохранять картинки
- сделан файл для отправки запросов через IDE PyCharm Pro
- проведен рефакторинг приложения: изменена структура, API подготовлена для версионирования, настроено сохранение и выдача статики и медиафайлов, изменен requirements.txt
- добавил шаблон и ссылку на последнюю версию API, через reverse и namespace пробросил URL API в шаблон
- сделана оптимизация забросов к БД
- добавлены модели в админку, настроено логгирование и Debug Toolbar


** Объявление класса абстрактным означает что его невозможно инстанцировать и он не имеет своей таблицы, 
  все наследники от него становятся реальными классами, пока у них также не будет объявлено abstract = True
